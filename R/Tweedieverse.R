...
#'
#' Fit a per-feature Tweedie generalized linear model to multi-omics features.
...
#'
#' library(data.table)
#' features <- fread("https://raw.githubusercontent.com/biobakery/
#' Maaslin2/master/inst/extdata/HMP2_taxonomy.tsv", sep ="\t")
#' metadata <-fread("https://raw.githubusercontent.com/biobakery/
#' Maaslin2/master/inst/extdata/HMP2_metadata.tsv", sep ="\t")
#'
#' ###############
#' # Format data #
#' ###############
